...
install_ioncube_ext() {
    ...
    curl_retry_on_18 --fail --silent --location -o $build_dir/.heroku/php/ioncube.tar.gz "https://github.com/rkasigi/heroku-buildpack-php-repository/raw/master/dist-heroku-18-stable/extensions/no-debug-non-zts-20180731/ioncube.tar.gz" || {
